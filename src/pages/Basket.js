  ...
  if (basket.length) {
    return (
      <Container style={{ display: 'flex', marginTop: "10%" }}>
            ...
            <tbody
              ...
              >
                ...
                <td><Button
                  ...
                  onClick={(e) => {
                    let myId = item.id
                    let filtered = basketItems.filter((item) => { return item.id !== myId })
        ...
        <div style={{ fontSize: '2rem', margin: '2rem', color: 'grey' }}>Общая стоимость
          <Summ></Summ>
          <Button style={{ margin: '2rem', fontSize: '3rem' }} variant='success'>Купить</Button>
